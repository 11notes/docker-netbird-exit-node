...
run 11notes/netbird-exit-node rootless
...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.64.5"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.5](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.5)
* [0.64.5-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.5-unraid)
* [0.64.5-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.5-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.64.5
docker pull ghcr.io/11notes/netbird-exit-node:0.64.5
docker pull quay.io/11notes/netbird-exit-node:0.64.5
```
...
*created 09.02.2026, 11:03:04 (CET)*