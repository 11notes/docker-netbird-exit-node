...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.62.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.62.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.62.3
docker pull ghcr.io/11notes/netbird-exit-node:0.62.3
docker pull quay.io/11notes/netbird-exit-node:0.62.3
```
...
*created 13.01.2026, 06:27:25 (CET)*