...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.70.5"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.70.5](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.5)
* [0.70.5-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.5-unraid)
* [0.70.5-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.5-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.70.5
docker pull ghcr.io/11notes/netbird-exit-node:0.70.5
docker pull quay.io/11notes/netbird-exit-node:0.70.5
```
...
*created 07.05.2026, 09:45:11 (CET)*