...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-exit-node | 34MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.73.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.73.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.73.0)
* [0.73.0-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.73.0-unraid)
* [0.73.0-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.73.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.73.0
docker pull ghcr.io/11notes/netbird-exit-node:0.73.0
docker pull quay.io/11notes/netbird-exit-node:0.73.0
```
...
*created 19.06.2026, 11:30:51 (CET)*