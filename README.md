...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.60.8"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.8](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.60.8)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.60.8
docker pull ghcr.io/11notes/netbird-exit-node:0.60.8
docker pull quay.io/11notes/netbird-exit-node:0.60.8
```
...
*created 19.12.2025, 06:23:55 (CET)*