...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.78.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.78.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.0)
* [0.78.0-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.0-unraid)
* [0.78.0-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.78.0
docker pull ghcr.io/11notes/netbird-exit-node:0.78.0
docker pull quay.io/11notes/netbird-exit-node:0.78.0
```
...
*created 04.09.2026, 06:08:06 (CET)*