...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.60.7"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.7](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.60.7)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.60.7
docker pull ghcr.io/11notes/netbird-exit-node:0.60.7
docker pull quay.io/11notes/netbird-exit-node:0.60.7
```
...
*created 05.12.2025, 06:22:20 (CET)*