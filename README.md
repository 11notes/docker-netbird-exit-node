...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.5"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.5](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.5)
* [0.74.5-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.5-unraid)
* [0.74.5-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.5-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.5
docker pull ghcr.io/11notes/netbird-exit-node:0.74.5
docker pull quay.io/11notes/netbird-exit-node:0.74.5
```
...
*created 15.07.2026, 09:16:45 (CET)*