...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.70.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.70.4](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.4)
* [0.70.4-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.4-unraid)
* [0.70.4-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.70.4-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.70.4
docker pull ghcr.io/11notes/netbird-exit-node:0.70.4
docker pull quay.io/11notes/netbird-exit-node:0.70.4
```
...
*created 30.04.2026, 09:33:48 (CET)*