...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.4](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.4)
* [0.74.4-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.4-unraid)
* [0.74.4-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.4-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.4
docker pull ghcr.io/11notes/netbird-exit-node:0.74.4
docker pull quay.io/11notes/netbird-exit-node:0.74.4
```
...
*created 11.07.2026, 09:13:31 (CET)*