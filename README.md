...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.65.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.1](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.1)
* [0.65.1-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.1-unraid)
* [0.65.1-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.65.1
docker pull ghcr.io/11notes/netbird-exit-node:0.65.1
docker pull quay.io/11notes/netbird-exit-node:0.65.1
```
...
*created 15.02.2026, 06:57:36 (CET)*