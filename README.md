...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.76.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.76.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.0)
* [0.76.0-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.0-unraid)
* [0.76.0-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.76.0
docker pull ghcr.io/11notes/netbird-exit-node:0.76.0
docker pull quay.io/11notes/netbird-exit-node:0.76.0
```
...
*created 30.07.2026, 09:36:20 (CET)*