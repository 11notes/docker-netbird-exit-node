...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.3)
* [0.74.3-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.3-unraid)
* [0.74.3-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.3-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.3
docker pull ghcr.io/11notes/netbird-exit-node:0.74.3
docker pull quay.io/11notes/netbird-exit-node:0.74.3
```
...
*created 09.07.2026, 10:29:36 (CET)*