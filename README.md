...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.60.9"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.9](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.60.9)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.60.9
docker pull ghcr.io/11notes/netbird-exit-node:0.60.9
docker pull quay.io/11notes/netbird-exit-node:0.60.9
```
...
*created 23.12.2025, 06:25:37 (CET)*