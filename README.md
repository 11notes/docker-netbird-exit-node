...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-exit-node | 36MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.78.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.78.1](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.1)
* [0.78.1-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.1-unraid)
* [0.78.1-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.78.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.78.1
docker pull ghcr.io/11notes/netbird-exit-node:0.78.1
docker pull quay.io/11notes/netbird-exit-node:0.78.1
```
...
*created 05.09.2026, 06:04:34 (CET)*