...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.6"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.6](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.6)
* [0.74.6-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.6-unraid)
* [0.74.6-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.6-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.6
docker pull ghcr.io/11notes/netbird-exit-node:0.74.6
docker pull quay.io/11notes/netbird-exit-node:0.74.6
```
...
*created 16.07.2026, 09:25:15 (CET)*