...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.0)
* [0.74.0-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.0-unraid)
* [0.74.0-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.0
docker pull ghcr.io/11notes/netbird-exit-node:0.74.0
docker pull quay.io/11notes/netbird-exit-node:0.74.0
```
...
*created 02.07.2026, 10:13:56 (CET)*