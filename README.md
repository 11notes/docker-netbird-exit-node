...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.64.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.4](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.4)
* [0.64.4-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.4-unraid)
* [0.64.4-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.4-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.64.4
docker pull ghcr.io/11notes/netbird-exit-node:0.64.4
docker pull quay.io/11notes/netbird-exit-node:0.64.4
```
...
*created 03.02.2026, 11:35:39 (CET)*