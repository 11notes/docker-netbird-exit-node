...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-exit-node | 33MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.72.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.72.2](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.72.2)
* [0.72.2-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.72.2-unraid)
* [0.72.2-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.72.2-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.72.2
docker pull ghcr.io/11notes/netbird-exit-node:0.72.2
docker pull quay.io/11notes/netbird-exit-node:0.72.2
```
...
*created 07.06.2026, 10:27:57 (CET)*