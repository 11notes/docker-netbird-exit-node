...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.67.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.4](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.4)
* [0.67.4-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.4-unraid)
* [0.67.4-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.4-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.67.4
docker pull ghcr.io/11notes/netbird-exit-node:0.67.4
docker pull quay.io/11notes/netbird-exit-node:0.67.4
```
...
*created 06.04.2026, 08:33:14 (CET)*