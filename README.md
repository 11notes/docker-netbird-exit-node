...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.66.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.66.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.3)
* [0.66.3-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.3-unraid)
* [0.66.3-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.3-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.66.3
docker pull ghcr.io/11notes/netbird-exit-node:0.66.3
docker pull quay.io/11notes/netbird-exit-node:0.66.3
```
...
*created 10.03.2026, 06:45:48 (CET)*