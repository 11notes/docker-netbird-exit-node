...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.60.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.60.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.60.3
docker pull ghcr.io/11notes/netbird-exit-node:0.60.3
docker pull quay.io/11notes/netbird-exit-node:0.60.3
```
...
*created 28.11.2025, 06:21:59 (CET)*