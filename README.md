...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.62.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.62.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.62.0
docker pull ghcr.io/11notes/netbird-exit-node:0.62.0
docker pull quay.io/11notes/netbird-exit-node:0.62.0
```
...
*created 08.01.2026, 06:26:13 (CET)*