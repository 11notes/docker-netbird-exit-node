...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.7"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.7](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.7)
* [0.74.7-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.7-unraid)
* [0.74.7-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.7-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.7
docker pull ghcr.io/11notes/netbird-exit-node:0.74.7
docker pull quay.io/11notes/netbird-exit-node:0.74.7
```
...
*created 18.07.2026, 09:02:56 (CET)*