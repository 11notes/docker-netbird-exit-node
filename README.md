...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.60.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.4](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.60.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.60.4
docker pull ghcr.io/11notes/netbird-exit-node:0.60.4
docker pull quay.io/11notes/netbird-exit-node:0.60.4
```
...
*created 29.11.2025, 06:20:41 (CET)*