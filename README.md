...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.67.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.0](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.0)
* [0.67.0-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.0-unraid)
* [0.67.0-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.67.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.67.0
docker pull ghcr.io/11notes/netbird-exit-node:0.67.0
docker pull quay.io/11notes/netbird-exit-node:0.67.0
```
...
*created 24.03.2026, 07:02:45 (CET)*