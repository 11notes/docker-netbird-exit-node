...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.68.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.1](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.1)
* [0.68.1-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.1-unraid)
* [0.68.1-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.68.1
docker pull ghcr.io/11notes/netbird-exit-node:0.68.1
docker pull quay.io/11notes/netbird-exit-node:0.68.1
```
...
*created 09.04.2026, 08:25:55 (CET)*