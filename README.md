...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.65.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.3)
* [0.65.3-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.3-unraid)
* [0.65.3-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.65.3-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.65.3
docker pull ghcr.io/11notes/netbird-exit-node:0.65.3
docker pull quay.io/11notes/netbird-exit-node:0.65.3
```
...
*created 20.02.2026, 06:55:33 (CET)*