...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.68.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.3](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.3)
* [0.68.3-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.3-unraid)
* [0.68.3-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.3-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.68.3
docker pull ghcr.io/11notes/netbird-exit-node:0.68.3
docker pull quay.io/11notes/netbird-exit-node:0.68.3
```
...
*created 15.04.2026, 08:59:18 (CET)*