...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.64.6"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.6](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.6)
* [0.64.6-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.6-unraid)
* [0.64.6-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.64.6-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.64.6
docker pull ghcr.io/11notes/netbird-exit-node:0.64.6
docker pull quay.io/11notes/netbird-exit-node:0.64.6
```
...
*created 13.02.2026, 07:01:43 (CET)*