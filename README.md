...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.68.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.2](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.2)
* [0.68.2-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.2-unraid)
* [0.68.2-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.68.2-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.68.2
docker pull ghcr.io/11notes/netbird-exit-node:0.68.2
docker pull quay.io/11notes/netbird-exit-node:0.68.2
```
...
*created 14.04.2026, 08:35:28 (CET)*