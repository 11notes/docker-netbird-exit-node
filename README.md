...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.76.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.76.1](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.1)
* [0.76.1-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.1-unraid)
* [0.76.1-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.76.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.76.1
docker pull ghcr.io/11notes/netbird-exit-node:0.76.1
docker pull quay.io/11notes/netbird-exit-node:0.76.1
```
...
*created 03.08.2026, 10:33:44 (CET)*