...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.66.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.66.2](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.2)
* [0.66.2-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.2-unraid)
* [0.66.2-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.66.2-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.66.2
docker pull ghcr.io/11notes/netbird-exit-node:0.66.2
docker pull quay.io/11notes/netbird-exit-node:0.66.2
```
...
*created 05.03.2026, 06:49:33 (CET)*