...
services:
  exit-node:
    image: "11notes/netbird-exit-node:0.74.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.2](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.2)
* [0.74.2-unraid](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.2-unraid)
* [0.74.2-nobody](https://hub.docker.com/r/11notes/netbird-exit-node/tags?name=0.74.2-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-exit-node:0.74.2
docker pull ghcr.io/11notes/netbird-exit-node:0.74.2
docker pull quay.io/11notes/netbird-exit-node:0.74.2
```
...
*created 04.07.2026, 09:45:14 (CET)*